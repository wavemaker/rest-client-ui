...
export function getCurrentDateTime(withTime, onlyTime) {
    const date = new Date();
    ...
    let returnValue = "";
    if (withTime)
        returnValue = valueWTime;
    if (!withTime)
        returnValue = valueWOTime;
    if (onlyTime)
        returnValue = time;
    return returnValue;
}
...
export const removeDuplicatesKeepFirst = (arr, key) => {
    const seen = {};
    const result = [];
...
export const findDuplicateObjects = (array, property) => {
    const seen = {};
    const duplicates = [];
...
export const removeSecondDuplicateSubstring = (inputString, substring) => {
...
export function findDuplicatesAcrossArrays(arrays, propertyName) {
    const seen = {};
    const duplicates = [];
...
export function removeDuplicatesByComparison(originalArray, comparisonArray, key) {
