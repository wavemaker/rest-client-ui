...
const providerState = createSlice({
    name: 'providerId',
    initialState: {
        selectedProvider: { providerId: '', authorizationUrl: '', accessTokenUrl: '', sendAccessTokenAs: '', accessTokenParamName: '', scopes: [], oAuth2Pkce: null, oauth2Flow: 'AUTHORIZATION_CODE' },
        providerAuthURL: "",
        providerList: [],
        configOpen: false,
        providerOpen: false
